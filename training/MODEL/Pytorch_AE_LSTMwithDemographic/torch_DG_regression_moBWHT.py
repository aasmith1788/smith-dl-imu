...
######### 설정 영역 ########
# 실험 관련 세팅
exp_name = "DG_DenseRegressor_1st_torch_minibatch"  # # 실험 이름 혹은 오늘 날짜
modelVersion = "DG_DenseRegressor_1st_torch_minibatch"
...
list_learningRate = [0.0002]  # opt1
list_batch_size = {0: 16}  # opt2
