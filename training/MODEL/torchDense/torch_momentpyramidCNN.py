...
RESULTS_DIR = join(BASE_RESULTS_DIR, 'momentpyramidCNNOPT')
...
def multi_seed_ensemble_training():
    ...
    print("="*80)
    print("STEP 3: MULTI-SEED ENSEMBLE TRAINING WITH YOUR OPTIMAL PARAMETERS")
    print("="*80)
    ...
    config = {
        'timestamp': timestamp,
        'step': 'multi_seed_ensemble_optimal_parameters',
        'n_seeds': N_SEEDS,
    ...
    print(f"\n{'='*80}")
    print("YOUR OPTIMAL ENSEMBLE TRAINING WITH GAUSSIAN NOISE COMPLETED!")
    print(f"{'='*80}")
    ...
    print("3. Your optimal Gaussian noise augmentation (0.100) for regularization")
