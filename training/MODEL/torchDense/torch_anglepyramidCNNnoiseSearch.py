...
RESULTS_DIR = r'R:\KumarLab3\PROJECTS\wesens\Data\Analysis\smith_dl\IMU Deep Learning\Training_results\PyramidAttnCNN_noise_search'
MODELS_DIR = join(RESULTS_DIR, 'models')
LOGS_DIR = join(RESULTS_DIR, 'logs')
NOISE_RESULTS_DIR = join(RESULTS_DIR, 'noise_search_results')

# OPTIMAL HYPERPARAMETERS FROM PYRAMIDATTNCNN OPTUNA SEARCH
BEST_PARAMS = {
    "kernels": [3, 5],  # Convert from '3-5' string
    "channels": [32, 64, 128],  # Convert from '32-64-128' string  
    "n_layers": 3,
