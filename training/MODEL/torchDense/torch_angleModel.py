...
output_base_dir = r'R:\KumarLab3\PROJECTS\wesens\Data\Analysis\smith_dl\IMU Deep Learning\Training_results\Dense_1st_Torch_Angle'
...
for numFold in range(totalFold):
    ...
    short_exp_name = 'dense_torch_angle'
