...
VARIANCE_LOSS_COEFFICIENT = 0.01 # 3% of base loss (range: 0.02-0.05)
VARIANCE_THRESHOLD = 0.85# Penalty activates when pred_spread < 90% of target_spread
...
class VarianceEncouragedLoss(nn.Module):
    ...
    def forward(self, y_pred, y_true):
        ...
        if VARIANCE_LOSS_ENABLED and y_pred.size(0) >= self.min_batch_size:
...
if __name__ == '__main__':
    multi_seed_ensemble_training_with_variance_loss()