...
class regressor(nn.Module):
    def __init__(self,filename,emb_dims,*args):
        ...
        self.dense = nn.Sequential(nn.Linear(emb_dims*4,2048), # 압축된 feature + demograpchic 정보 3개를 가로로 추가
                                        nn.ReLU(),
    ...
    def forward(self, x_imu, x_dg):
        ...
        concated = torch.cat((compressed_features, dg_features), 1) # [batchsize, 압축피쳐] + [batchzie, dg피쳐 3개(압축피쳐 3개분)] = [batchsize, 합_피쳐(총4개)]
